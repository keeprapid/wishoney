...
#        self.apnscon = self.session.get_connection("push_sandbox", cert_file="/opt/Keeprapid/Wishoney/server/conf/apns-dev.pem")
        self.apnscon_product = self.session.get_connection("push_production", cert_file="/opt/Keeprapid/Wishoney/server/conf/apns-product-wishoney.pem")
